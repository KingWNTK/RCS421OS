...
#
KERNEL_OBJS = kernel.o memory_manager.o trap_handler.o process_controller.o kernel_call_handler.o
KERNEL_SRCS = kernel.c memory_manager.c trap_handler.c process_controller.c kernel_call_handler.c
